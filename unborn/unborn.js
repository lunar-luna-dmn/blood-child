...
var texture = new THREE.TextureLoader().load( '/public/media/organic-tunnel.jpeg', function ( texture ) { //update media paths for vercel
    texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
    texture.offset.set(0, 0);
    texture.repeat.set(3, 1);
});

var bloodtexture = new THREE.TextureLoader().load( '/public/media/blood-texture.jpeg', function ( texture ) {
...
localVideo.src = '/public/media/tunnel.mp4';
localVideo.play(); 
...
var ovumTexture = new THREE.TextureLoader().load('/public/media/ovum.png');
