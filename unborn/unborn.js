...
var texture = new THREE.TextureLoader().load( '/media/organic-tunnel.jpeg', function ( texture ) { //when deployed on Vercel, these media paths need to be absolute or properly resolved from the root
